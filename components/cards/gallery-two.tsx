...
const GalleryTwo: React.FC = () => {
  ...
  return (
    <div className="w-full center relative h-screen overflow-hidden">
      <motion.div
        layout
      ...
      {activeItem && (
        ...
        >
          <AnimatePresence mode="popLayout">
            <motion.div
              key={activeItem.id}
              className="w-full h-screen flex items-center justify-center gap-10 flex-col overflow-hidden "
              transition={{ duration: 0.5, ease: "easeInOut" }}
              layout
            >
              <motion.div
