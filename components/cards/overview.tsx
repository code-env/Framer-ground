...
const Overview = () => {
  ...
  return (
    <div className="h-screen center bg-primary w-full relative">
      <motion.ul
  ...
  return (
    ...
    >
      <div className="flex gap-6 h-20">
        ...
        <div className="border-b h-full items-start justify-center flex flex-col  flex-1 border-neutral-800 dark:border-neutral-200">
    ...
    <>
      ...
      <AnimatePresence>
        {!!props.card && (
          ...
          >
            <motion.div
              className="p-4 w-fit  relative overflow-hidden flex items-center justify-center flex-col bg-primary rounded-3xl"
              layoutId={`card-${props.card.id}`}
            >
