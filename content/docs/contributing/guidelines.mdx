...
date: 2024-10-07
description: Guidelines for contributing to Ground.
---

## Component Generation

Use `pnpm ground:new` for creating new components. This command will add some default files. More details can be found in the [contributing components](/docs/contributing/components) documentation.
...
- Use images in the `/public/others` directory.
